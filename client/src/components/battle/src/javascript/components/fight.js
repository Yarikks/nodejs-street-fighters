...
export async function fight(firstFighter, secondFighter) {
  ...
  let fighterOne = Object.assign(firstFighter, { ...firstFighter, "block": false, "indicatorId": 'left-fighter-indicator', "currentHealth": firstFighter.health, "lastComboHit": 0, "position": 'left', "attack": firstFighter.power });
  let fighterTwo = Object.assign(secondFighter, { ...secondFighter, "block": false, "indicatorId": 'right-fighter-indicator', "currentHealth": secondFighter.health, "lastComboHit": 0, "position": 'right', "attack": secondFighter.power });
