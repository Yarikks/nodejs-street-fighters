...
export default function Fighter({
  ...
  const fighterInfo = (selectedFighter) => {
    if (className.includes("right")) {
      return (
        <>
          <img src={selectedFighter.source} className="fighter-preview___img" />
          <div className="fighter-info__block">
  ...
  return (
    <div>
      <FormControl className={classes.formControl}>
        ...
        {selectedFighter ? (
          <div className={"fighter-preview___root " + className}>
            {fighterInfo(selectedFighter)}
          </div>
        ) : null}
      </FormControl>
    </div>
